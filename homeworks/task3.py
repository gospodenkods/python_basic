...
class Cell:
    ...
    def __add__(self, inothers):
        return Cell(self.quantity + inothers.quantity)
...
next_cells = Cell(12)
print(first_cells)
print(first_cells + next_cells)
print(next_cells - first_cells)
print(next_cells.make_order(5))
print(first_cells.make_order(10))
print(first_cells / next_cells)
